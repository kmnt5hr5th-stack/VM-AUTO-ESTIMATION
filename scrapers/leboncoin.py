...
_GENERATIONS: dict[str, list[tuple[int, int]]] = {
    ...
    "volvo_xc40":         [(2017, 2030)],
    "volvo_v60":          [(2010, 2018), (2018, 2030)],
    "volvo_v90":          [(2016, 2030)],
    "volvo_s60":          [(2010, 2018), (2018, 2030)],
    "mini_mini":          [(2006, 2014), (2014, 2023), (2023, 2030)],
    # Dacia
    "dacia_sandero":      [(2008, 2013), (2013, 2021), (2021, 2030)],
    "dacia_logan":        [(2004, 2013), (2013, 2021), (2021, 2030)],
    "dacia_duster":       [(2010, 2018), (2018, 2030)],
    "dacia_dokker":       [(2012, 2022)],
    "dacia_lodgy":        [(2012, 2022)],
    "dacia_spring":       [(2021, 2030)],
    # Renault
    "renault_twingo":     [(2007, 2014), (2014, 2030)],
    "renault_kangoo":     [(2008, 2021), (2021, 2030)],
    "renault_talisman":   [(2015, 2022)],
    "renault_koleos":     [(2008, 2017), (2017, 2030)],
    "renault_espace":     [(2014, 2023), (2023, 2030)],
    "renault_arkana":     [(2019, 2030)],
    "renault_austral":    [(2022, 2030)],
    # Peugeot
    "peugeot_107":        [(2005, 2014)],
    "peugeot_207":        [(2006, 2012)],
    "peugeot_206":        [(1998, 2009)],
    "peugeot_408":        [(2022, 2030)],
    # Citroën
    "citroen_c4":         [(2004, 2011), (2011, 2018), (2020, 2030)],
    "citroen_c5":         [(2008, 2017)],
    "citroen_c5_aircross":[(2018, 2030)],
    "citroen_c3_aircross":[(2017, 2030)],
    "citroen_ds3":        [(2009, 2019), (2019, 2030)],
    # DS
    "ds_ds3":             [(2009, 2019), (2019, 2030)],
    "ds_ds4":             [(2011, 2021), (2021, 2030)],
    "ds_ds5":             [(2011, 2018)],
    "ds_ds7":             [(2017, 2030)],
    # Volkswagen
    "volkswagen_t_roc":   [(2017, 2022), (2022, 2030)],
    "volkswagen_t_cross":  [(2019, 2030)],
    "volkswagen_touareg":  [(2010, 2018), (2018, 2030)],
    "volkswagen_sharan":   [(2010, 2022)],
    "volkswagen_touran":   [(2010, 2015), (2015, 2030)],
    "volkswagen_up":       [(2011, 2030)],
    "volkswagen_id_3":     [(2020, 2030)],
    "volkswagen_id_4":     [(2021, 2030)],
    # BMW
    "bmw_serie_1":        [(2004, 2011), (2011, 2019), (2019, 2030)],
    "bmw_serie_2":        [(2013, 2021), (2021, 2030)],
    "bmw_serie_4":        [(2013, 2020), (2020, 2030)],
    "bmw_serie_7":        [(2008, 2015), (2015, 2022), (2022, 2030)],
    "bmw_x2":             [(2018, 2024), (2024, 2030)],
    "bmw_x4":             [(2013, 2018), (2018, 2030)],
    "bmw_x6":             [(2008, 2014), (2014, 2019), (2019, 2030)],
    # Mercedes
    "mercedes_classe_b":  [(2011, 2018), (2018, 2030)],
    "mercedes_gla":       [(2013, 2020), (2020, 2030)],
    "mercedes_glb":       [(2019, 2030)],
    "mercedes_gls":       [(2012, 2019), (2019, 2030)],
    "mercedes_classe_s":  [(2013, 2020), (2020, 2030)],
    "mercedes_cla":       [(2013, 2019), (2019, 2030)],
    # Audi
    "audi_a1":            [(2010, 2018), (2018, 2030)],
    "audi_a6":            [(2011, 2018), (2018, 2030)],
    "audi_q2":            [(2016, 2020), (2020, 2030)],
    "audi_q7":            [(2005, 2015), (2015, 2030)],
    "audi_q8":            [(2018, 2030)],
    "audi_e_tron":        [(2019, 2030)],
    # Ford
    "ford_puma":          [(2019, 2030)],
    "ford_c_max":         [(2010, 2019)],
    "ford_ecosport":      [(2013, 2018), (2018, 2030)],
    "ford_mustang":       [(2015, 2023), (2023, 2030)],
    # Toyota
    "toyota_c_hr":        [(2016, 2023), (2023, 2030)],
    "toyota_prius":       [(2009, 2016), (2016, 2022), (2022, 2030)],
    "toyota_land_cruiser":[(2009, 2021), (2021, 2030)],
    "toyota_aygo":        [(2005, 2014), (2014, 2022)],
    "toyota_proace":      [(2013, 2016), (2016, 2030)],
    # Honda
    "honda_civic":        [(2011, 2017), (2017, 2022), (2022, 2030)],
    "honda_cr_v":         [(2012, 2018), (2018, 2030)],
    "honda_jazz":         [(2008, 2015), (2015, 2020), (2020, 2030)],
    "honda_hr_v":         [(2015, 2021), (2021, 2030)],
    # Mazda
    "mazda_3":            [(2009, 2013), (2013, 2019), (2019, 2030)],
    "mazda_6":            [(2012, 2018), (2018, 2030)],
    "mazda_cx_5":         [(2012, 2017), (2017, 2030)],
    "mazda_cx_30":        [(2019, 2030)],
    # Alfa Romeo
    "alfa_romeo_giulia":  [(2016, 2030)],
    "alfa_romeo_stelvio": [(2017, 2030)],
    "alfa_romeo_giulietta":[(2010, 2016), (2016, 2021)],
    "alfa_romeo_tonale":  [(2022, 2030)],
    # Fiat
    "fiat_500":           [(2007, 2020), (2020, 2030)],
    "fiat_tipo":          [(2015, 2020), (2020, 2030)],
    "fiat_punto":         [(2005, 2018)],
    "fiat_panda":         [(2011, 2030)],
    # Jeep
    "jeep_renegade":      [(2014, 2019), (2019, 2030)],
    "jeep_compass":       [(2017, 2021), (2021, 2030)],
    "jeep_grand_cherokee":[(2010, 2021), (2021, 2030)],
    # Nissan
    "nissan_qashqai":     [(2006, 2013), (2013, 2021), (2021, 2030)],
    "nissan_juke":        [(2010, 2019), (2019, 2030)],
    "nissan_micra":       [(2010, 2017), (2017, 2030)],
    "nissan_leaf":        [(2010, 2017), (2017, 2030)],
    "nissan_x_trail":     [(2013, 2022), (2022, 2030)],
    # Suzuki
    "suzuki_vitara":      [(2015, 2019), (2019, 2030)],
    "suzuki_swift":       [(2010, 2017), (2017, 2030)],
    "suzuki_sx4":         [(2013, 2021), (2021, 2030)],
    # Mitsubishi
    "mitsubishi_outlander":[(2012, 2018), (2018, 2030)],
    "mitsubishi_asx":     [(2010, 2016), (2016, 2022), (2022, 2030)],
    # Hyundai
    "hyundai_kona":       [(2017, 2023), (2023, 2030)],
    "hyundai_ioniq":      [(2016, 2022), (2022, 2030)],
    "hyundai_i20":        [(2009, 2014), (2014, 2020), (2020, 2030)],
    "hyundai_santa_fe":   [(2012, 2018), (2018, 2030)],
    # Kia
    "kia_ceed":           [(2012, 2018), (2018, 2030)],
    "kia_niro":           [(2016, 2022), (2022, 2030)],
    "kia_sorento":        [(2012, 2020), (2020, 2030)],
    "kia_stonic":         [(2017, 2030)],
    # Subaru
    "subaru_forester":    [(2013, 2019), (2019, 2030)],
    "subaru_xv":          [(2011, 2017), (2017, 2030)],
    "subaru_outback":     [(2014, 2020), (2020, 2030)],
    # Lexus
    "lexus_ct":           [(2011, 2018), (2018, 2030)],
    "lexus_ux":           [(2018, 2030)],
    "lexus_nx":           [(2014, 2021), (2021, 2030)],
    "lexus_rx":           [(2015, 2022), (2022, 2030)],
    # Land Rover / Jaguar
    "land_rover_evoque":  [(2011, 2019), (2019, 2030)],
    "land_rover_discovery_sport": [(2014, 2019), (2019, 2030)],
    "land_rover_defender":[(2020, 2030)],
    "land_rover_freelander":[(2006, 2015)],
    "jaguar_e_pace":      [(2017, 2021), (2021, 2030)],
    "jaguar_f_pace":      [(2016, 2021), (2021, 2030)],
    "jaguar_xe":          [(2015, 2019), (2019, 2030)],
    "jaguar_xf":          [(2015, 2020), (2020, 2030)],
    # Seat
    "seat_ibiza":         [(2008, 2017), (2017, 2030)],
    "seat_arona":         [(2017, 2022), (2022, 2030)],
    "seat_tarraco":       [(2018, 2030)],
    # Skoda
    "skoda_fabia":        [(2007, 2014), (2014, 2021), (2021, 2030)],
    "skoda_scala":        [(2019, 2030)],
    "skoda_karoq":        [(2017, 2022), (2022, 2030)],
    "skoda_superb":       [(2015, 2019), (2019, 2030)],
    # Porsche
    "porsche_cayenne":    [(2010, 2017), (2017, 2030)],
    "porsche_macan":      [(2014, 2021), (2021, 2030)],
    "porsche_panamera":   [(2016, 2030)],
    # Tesla
    "tesla_model_3":      [(2017, 2024), (2024, 2030)],
    "tesla_model_y":      [(2020, 2030)],
    "tesla_model_s":      [(2012, 2021), (2021, 2030)],
    "tesla_model_x":      [(2015, 2021), (2021, 2030)],
}
